...
var EV_INTRA_COLLEGE = [
  ...
  },
  {
    ...
    date: '20-02-2020',
    status: 'past',
    title: '“Code Challenger” — Pcode, Scode, Jcode, Ccode',
    description: 'Inter Collegiate contest covering Python, SQL, Java & C programming for B.Tech students of all branches, MCA and external participants (494 participants).',
    desc: '“Code Challenger” (Pcode, Scode, Jcode, Ccode) organized on 20-2-2020 by Faculty and Student Committee Members for B.Tech students of all branches, MCA and External participants. 494 participants.',
    facts: [["494", "Participants"], ["Python, SQL, Java, C"], ["Inter Collegiate"]],
    banners: ["Code Challenger 2020"],
    gallery: [],
    fields: {
      'Date': '20-02-2020',
      'Type': 'Inter Collegiate',
      'Organizers': 'Faculty and Student Committee Members',
      'Target Audience': 'B.Tech students of all branches, MCA and External participants',
      'Participants': '494'
    },
    registerUrl: null,
    photo: null,
  ...
  },
  {
    ...
    description: 'Inter Collegiate PPT contest for B.Tech students of CSE and External participants (132 participants).',
    desc: 'Explore-IT (PPT Contest) organized on 24-04-2021 by Faculty and Student Committee Members for B.Tech students of CSE and External participants. 132 participants.',
    facts: [["132", "Participants"], ["CSE & External"], ["Inter Collegiate"]],
    banners: ["Explore-IT PPT Contest 2021"],
    gallery: [],
    fields: {
      'Date': '24-04-2021',
      'Type': 'Inter Collegiate',
